...
module BoredTestRunner
  ...
  def self.env_override(m)
    live = getenv("BORED_TEST_LIVE")
    override = getenv("BORED_TEST_OVERRIDE")
    ...
    explain = getenv("BORED_TEST_EXPLAIN")
    m["BORED_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = BoredTestRunner
Helpers = BoredHelpers
Vs = VoxgigStruct
