# Bored Golang SDK Reference

Complete API reference for the Bored Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *BoredSDK`
...
#### `Activity(data map[string]any) BoredEntity`
