...
func (sdk *BoredSDK) OptionsMap() map[string]any {
...
func (sdk *BoredSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *BoredSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *BoredSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BoredSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *BoredSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *BoredSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("BoredSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *BoredSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BoredSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("BoredSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
