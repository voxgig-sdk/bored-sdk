...
(0, node_test_1.describe)('ActivityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-activity', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-activity', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.BORED_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BoredSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['BORED_TEST_ACTIVITY_ENTID'];
