...
class BoredProxyFeature extends BoredBaseFeature
{
    ...
    public function init(BoredContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BoredContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
