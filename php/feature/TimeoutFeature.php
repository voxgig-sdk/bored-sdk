...
class BoredTimeoutFeature extends BoredBaseFeature
{
    ...
    private function _with_timeout(BoredContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BoredContext $_ctx, float $ms): void
    {
        $client = $this->client;
