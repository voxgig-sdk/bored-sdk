...
class BoredRbacFeature extends BoredBaseFeature
{
    ...
    private function _required(BoredContext $ctx): ?string
    {
    ...
    private function _reject(BoredContext $ctx, string $required): void
    {
    ...
    private function _track(BoredContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
