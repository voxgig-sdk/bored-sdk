...
class BoredRatelimitFeature extends BoredBaseFeature
{
    ...
    private function _acquire(BoredContext $ctx): void
    {
    ...
    private function _track(BoredContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
