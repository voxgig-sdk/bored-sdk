...
class BoredCacheFeature extends BoredBaseFeature
{
    ...
    private function _through(BoredContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
