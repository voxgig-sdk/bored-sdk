...
// Bored SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class BoredTestFeature extends BoredBaseFeature
{
    ...
    public function init(BoredContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BoredContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BoredContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BoredContext $ctx, $op, $args): array
    {
