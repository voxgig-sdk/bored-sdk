...
// Bored SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BoredMakeRequest
{
    public static function call(BoredContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BoredResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BoredResponse($fetched);
        } else {
