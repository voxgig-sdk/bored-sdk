...
// Bored SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BoredSDK::test)
...
{
    private const SDK_CLASS = 'BoredSDK';
    ...
    private const SDK_BASE = 'bored_sdk';
