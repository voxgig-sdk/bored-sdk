...
class BoredTestRunner
{
    ...
    {
        $live = self::getenv('BORED_TEST_LIVE');
        $override = self::getenv('BORED_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BORED_TEST_EXPLAIN');
...
class_alias('BoredTestRunner', 'Runner');
class_alias('BoredHelpers', 'Helpers');
