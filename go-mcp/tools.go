...
type Args struct {
	Entity string         `json:"entity" jsonschema:"activity"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BoredSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "bored_list",
		Description: "List records from Bored. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "bored_load",
		Description: "Load a single record from Bored. " +
...
func runOp(client *sdk.BoredSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BoredSDK, name string) (sdk.BoredEntity, error) {
