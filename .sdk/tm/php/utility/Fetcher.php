...
class BoredFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BoredSDK/1.0)';
    ...
    public static function call(BoredContext $ctx, string $fullurl, array $fetchdef): array
    {
