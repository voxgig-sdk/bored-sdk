...
class BoredStreamingFeature extends BoredBaseFeature
{
    ...
    private function _iterate(BoredResult $result): \Generator
    {
    ...
    private function _streamable(BoredContext $ctx): bool
    {
