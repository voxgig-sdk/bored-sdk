...
class BoredNetsimFeature extends BoredBaseFeature
{
    ...
    private function _simulate(BoredContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BoredContext $ctx, array $applied): void
    {
        $client = $this->client;
