...
|---|---|---|
| `ts/` | @voxgig-sdk/bored-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/bored-sdk \
      --repository voxgig-sdk/bored-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/bored-sdk` shows it, and
`npm trust revoke @voxgig-sdk/bored-sdk --id=<id>` removes it.
