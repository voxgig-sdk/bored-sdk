...
BoredSDK._make_feature = _make_feature


function BoredSDK.new(options)
  local self = setmetatable({}, BoredSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function BoredSDK:get_utility()
  return Utility.copy(self._utility)
end


function BoredSDK:get_root_ctx()
  return self._rootctx
end


function BoredSDK:prepare(fetchargs)
...
function BoredSDK:direct(fetchargs)
...
-- by passing it.
function BoredSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function BoredSDK:graphql(query, variables, ctrl)
...
function BoredSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = BoredSDK.new(sdkopts)
  sdk.mode = "test"
