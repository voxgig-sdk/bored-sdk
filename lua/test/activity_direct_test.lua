...
describe("ActivityDirect", function()
  it("should direct-load-activity", function()
    local setup = activity_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-activity", setup.live and "live" or "unit")
