...
from bored_sdk.core.response import BoredResponse
from bored_sdk.core.operation import BoredOperation
from bored_sdk.core.error import BoredError
from bored_sdk.core import helpers
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = BoredSDK.test(None, None)
        ...
        class TestInitFeature(BoredBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(BoredBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = BoredSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = BoredSDK.test(None, setup_opts)
