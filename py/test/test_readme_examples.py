# Bored SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BoredSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BoredSDK(...) and BoredSDK.test(...) become
#      BoredSDK.test({"entity": {...}}) seeding one mock record (id "test01")
