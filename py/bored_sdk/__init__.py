...
from bored_sdk.utility import register

# Load features
from bored_sdk.feature.base_feature import BoredBaseFeature
from bored_sdk.features import _has_feature, _make_feature
...
class BoredSDK:
    ...
    def get_utility(self):
        return BoredUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BoredSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Activity(self, data=None) -> "ActivityEntity":
        ...
        from bored_sdk.entity.activity_entity import ActivityEntity
