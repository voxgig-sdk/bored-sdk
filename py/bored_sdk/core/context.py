...
from bored_sdk.core.helpers import get_ctx_prop, to_map
...
class BoredContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, BoredResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BoredError(code, msg, self)
