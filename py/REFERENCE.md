# Bored Python SDK Reference

Complete API reference for the Bored Python SDK.
...
#### `BoredSDK.test(testopts=None, sdkopts=None)`
...
```python
result, err = client.Activity().load({"id": "activity_id"})
```
